...
typedef struct HapContext {
	...
	int opt_texture_quality_hap_r; /* User-requested texture compression quality (encoder only) */
	int opt_texture_quality_hap_h; /* User-requested texture compression quality (encoder only) */
